...
const Register = () => {
  ...
  const { register, signInWithGoogle, user: authUser } = useAuth();
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // AuthContext will handle user doc creation in Firestore via onAuthStateChanged
    ...
    <div className="login-page">
      <div className="login-card animate-fade">
        <div className="login-header">
          ...
          <p>Join BEAUTY GLOWRY for a personalized experience</p>
        </div>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .input-group label { display: block; font-weight: 700; font-size: 14px; margin-bottom: 10px; }
        ...
        .login-submit { width: 100%; height: 56px; background: var(--primary-dark); color: white; border-radius: 12px; font-weight: 800; font-size: 16px; display: flex; align-items: center; justify-content: center; gap: 12px; transition: var(--transition); margin-top: 10px; }
        ...
        .social-login { margin-top: 32px; text-align: center; border-top: 1px solid var(--border); padding-top: 24px; }
